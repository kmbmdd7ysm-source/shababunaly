...
export function normalizeLhaProduct(p) {
  ...
  return {
    ...
    availability: !isPhysicalActive ? 'sold-out' : inventoryTracking && stock <= 0 ? 'sold-out' : 'in-stock',
    image: p.image ?? null,
