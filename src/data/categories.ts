...
export const categories = [
  ...
  { slug:'clothing', name:{en:'Clothing',ar:'الملابس'}, image:E.lebronFullBody, subcategories:[
    ...
    {slug:'practice-jerseys',name:{en:'Practice Jerseys',ar:'سيريات التمرين'},image:E.lebronUsa},
    {slug:'practice-shorts',name:{en:'Practice Shorts',ar:'شورتات التمرين'},image:E.curryLayupWide},
    {slug:'t-shirts',name:{en:'T-Shirts',ar:'تيشيرتات'},image:E.tatumSigning},
    {slug:'hoodies',name:{en:'Hoodies',ar:'هوديز'},image:E.lameloSpaceStanding},
    {slug:'pants',name:{en:'Pants',ar:'سراويل'},image:E.lebronFullBody},
    {slug:'tracksuits',name:{en:'Tracksuits',ar:'بدلات رياضية'},image:E.franceGroup},
  ...
  { slug:'footwear', name:{en:'Footwear',ar:'الأحذية'}, image:E.redShoe, subcategories:[
  ...
  { slug:'accessories', name:{en:'Accessories',ar:'الإكسسوارات'}, image:E.lebronCrown, subcategories:[
    ...
    {slug:'training-accessories',name:{en:'Training Accessories',ar:'إكسسوارات التدريب'},image:E.curryActionAlt},
  ]},
  { slug:'basketballs', name:{en:'Basketballs',ar:'كرات السلة'}, image:E.curryPortraitBall, subcategories:[
    {slug:'indoor',name:{en:'Indoor',ar:'داخل الصالات'},image:E.usaWomanCelebrate},
    {slug:'outdoor',name:{en:'Outdoor',ar:'خارج الصالات'},image:E.lukaFanSelfie},
    {slug:'indoor-outdoor',name:{en:'Indoor / Outdoor',ar:'داخلي وخارجي'},image:E.curryDribbleWide},
    {slug:'custom-balls',name:{en:'Custom Basketballs',ar:'كرات بتصميم خاص'},image:E.whiteStudioDribbler},
  ]},
  { slug:'equipment', name:{en:'Equipment',ar:'المعدات'}, image:E.jordanDunkEvent, subcategories:[
    {slug:'hoops-backboards',name:{en:'Hoops & Backboards',ar:'السلات والبوردات'},image:E.shanghaiPlayers},
    {slug:'rims-nets',name:{en:'Rims & Nets',ar:'الريمات والشبكات'},image:E.curryLayupVertical2},
