  ...
  return (
    <>
      <Seo
        ...
        path="/lha-store"
      />
      <section className="lha-store-hero">
        <div className="container">
          <img src="/brand/lha-wordmark-white.svg" alt="Libya Hoops Academy" />
          <p>OFFICIAL STORE · POWERED BY SHABABUNA</p>
          <h1>{pick({ en: 'LHA Clothing & Accessories', ar: 'ملابس وإكسسوارات LHA' })}</h1>
          <span>
            {pick({
      ...
      <section className="section">
        <div className="container">
          <div className="store-toolbar">
            <div>
              <p className="section-label">LHA OFFICIAL STORE</p>
              <h2 className="section-title">
                {pick({ en: 'Shop the full collection', ar: 'تسوّق المجموعة كاملة' })}
              </h2>
            </div>
