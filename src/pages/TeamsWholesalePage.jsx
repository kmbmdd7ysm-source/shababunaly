  ...
  return (
    <>
      ...
      <RouteMasthead
        ...
        trail={[{ label: pick({ en: 'Teams & Wholesale', ar: 'الأندية والجملة' }) }]}
        figure={{ value: packages.length, label: pick({ en: 'packages', ar: 'باقات' }) }}
      >
      ...
      <section
        className="gw-lifecycle"
        aria-label={pick({ en: 'Order lifecycle', ar: 'دورة الطلب' })}
      >
