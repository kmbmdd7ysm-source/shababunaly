...
export default function ShopPage(): ReactElement {
  ...
  const description =
    cat?.slug === 'ready-to-ship'
      ...
      : pick({
          en: 'Basketball gear, ready now or made for your team.',
          ar: 'كل احتياجات كرة السلة — جاهزة الآن أو مصممة لفريقك.',
        });
          ...
          <div className="gw-entrance-inner">
            <div className="gw-entrance-lede">
              ...
              <p className="gw-entrance-copy">
                {pick({
                  en: 'Gear for the court. Ready now or built for your team.',
                  ar: 'كل ما تحتاجه للملعب — جاهز الآن أو مصمم لفريقك.',
                })}
              </p>
            ...
            <ul className="gw-entrance-gates gw-entrance-gates--visual">
              <li>
                <div className="gw-gate-shell" data-dept="ready-to-ship">
              ...
              {departments
                ...
                .map((item) => (
                  <li key={item.slug}>
                    <div className="gw-gate-shell" data-dept={item.slug}>
