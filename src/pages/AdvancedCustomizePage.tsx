            ...
            {step === 'model' || step === 'design' ? (
              ...
              >
                <Garment3DStage
                  ...
                  teamName={String(design.teamName || '')}
                  playerName={String(design.playerName || '')}
                  playerNumber={String(design.number || '00')}
                  pattern={String(design.pattern || 'solid')}
                  logoPreview={String(design.logoPreview || '') || undefined}
                />
              </Suspense>
            ) : (
        ...
        <div className="gw-lab-dock">
          <header className="gw-lab-head">
            ...
            <p className="gw-lab-lede">
              {pick({
                en: 'Design. Roster. Proof. Quote.',
                ar: 'صمّم. أضف الفريق. راجع البروفة. اطلب السعر.',
              })}
            </p>
          </header>
