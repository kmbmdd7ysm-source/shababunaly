          ...
          <div className="gw-act-inner gw-game-inner">
            <header className="gw-act-head">
              ...
              <p className="gw-act-body">
                {pick({
                  en: 'Apparel, footwear, balls and equipment — built around the game.',
                  ar: 'ملابس وأحذية وكرات ومعدات — مبنية حول اللعبة.',
                })}
              </p>
            </header>
              ...
              <p className="gw-act-figure">
                {ready.length > 0 ? (
                  ...
                  <span className="gw-act-lede">
                    {pick({
                      en: 'Verified warehouse stock appears here as soon as it is ready.',
                      ar: 'يظهر مخزون المستودع هنا فور توثيقه وجاهزيته.',
                    })}
                  </span>
                )}
              </p>
        ...
        >
          <div className="gw-act-inner gw-workshop-inner">
            <div>
              ...
              <p className="gw-act-body">
                {pick({
                  en: 'Build the kit. See it. Approve it. Produce it.',
                  ar: 'صمّم الطقم. شاهده. اعتمده. ثم ابدأ التصنيع.',
                })}
              </p>
