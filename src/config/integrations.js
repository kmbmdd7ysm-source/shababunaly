export const integrations = Object.freeze({
  formspreeEndpoint: String(import.meta.env.VITE_FORM_ENDPOINT || 'https://formspree.io/f/mvzenjgv').trim(),
  ...
  onlineCard: Object.freeze({
    ...
    publishableKey: String(import.meta.env.VITE_PAYMENTS_PUBLISHABLE_KEY || import.meta.env.VITE_STRIPE_PUBLISHABLE_KEY || '').trim(),
