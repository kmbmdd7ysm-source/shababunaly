    ...
    <div className="empty-state" role="status">
      <span className="empty-mark" aria-hidden="true">
        <svg viewBox="0 0 120 120" width="56" height="56" fill="none">
          ...
          <path d="M60 8c18 16 28 34 28 52s-10 36-28 52" stroke="currentColor" strokeWidth="2" />
          <path d="M60 8c-18 16-28 34-28 52s10 36 28 52" stroke="currentColor" strokeWidth="2" />
