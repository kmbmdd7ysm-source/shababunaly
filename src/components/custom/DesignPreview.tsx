...
function TextBlock({
  ...
  return (
    <g textAnchor="middle" fill={design.secondary} fontFamily={fontFamily}>
      {!back && design.logoPreview ? (
        <image
          href={design.logoPreview}
          x={x - 34}
          y={y - 86}
          width="68"
          height="68"
      ...
      <text x={x} y={y} fontSize="26" fontWeight="800" letterSpacing="2.2">
        {back ? player : team}
      </text>
      <text x={x} y={numberY} fontSize="104" fontWeight="900" letterSpacing="-5">
        {number}
      </text>
      {!back && design.sponsorName ? (
        <text x={x} y={numberY + 50} fontSize="15" fontWeight="700" letterSpacing="1.8">
          {safeText(design.sponsorName, '', 22)}
        </text>
      ) : null}
        ...
        {[70, 500].map((offset, index) => {
          ...
          return (
            <g key={offset} transform={`translate(${offset} 38)`}>
              <path
                d="M116 20L172 54H248L304 20L384 82L350 150L318 128V466H102V128L70 150L36 82Z"
                fill={baseFill}
                stroke={design.secondary}
                strokeWidth="5"
              />
              {split ? (
                <path d="M210 55H384V466H210Z" fill={design.secondary} opacity=".33" />
              ) : null}
              {stripe ? (
                <path
                  d="M100 126L132 141V466H102V128ZM320 141L350 126V466H318Z"
              ...
              <path
                d={
                  design.neckline === 'v-neck'
                    ? 'M172 54L210 105L248 54'
                    : design.neckline === 'crew'
                      ? 'M172 54Q210 98 248 54'
                      : 'M172 54Q210 122 248 54'
                }
                fill="none"
                stroke={design.secondary}
                strokeWidth="13"
              ...
              {stripe ? (
                <path
                  d="M96 604L118 478H142L132 604ZM324 604L302 478H278L288 604Z"
                  fill={design.secondary}
                />
              ) : null}
              {split ? (
                <path d="M210 478H302L324 604H210Z" fill={design.secondary} opacity=".33" />
              ) : null}
              <text
                x="210"
                y="570"
      ...
      {[70, 500].map((offset, index) => (
        <g key={offset} transform={`translate(${offset} 44)`} filter={`url(#${id}-shadow)`}>
          <path
            d={
              shirt
                ? 'M84 80L164 24H256L336 80L390 126L344 192L316 166V484H104V166L76 192L30 126Z'
                : 'M118 20L172 54H248L302 20L384 82L350 150L318 128V466H102V128L70 150L36 82Z'
            }
            fill={baseFill}
            stroke={design.secondary}
            strokeWidth="5"
          ...
          {design.pattern === 'side-stripe' ? (
            <path d="M102 128H132V466H102ZM288 128H318V466H288Z" fill={design.secondary} />
          ) : null}
    ...
    <svg viewBox="0 0 920 580" role="img" aria-label="Custom basketball shorts preview">
      ...
      {[110, 510].map((offset, index) => (
        <g key={offset} transform={`translate(${offset} 42)`} filter={`url(#${id}-shadow)`}>
          <path
            d="M95 30H305L348 470L230 462L200 280L170 462L52 470Z"
            fill={baseFill}
            stroke={design.secondary}
            strokeWidth="7"
          />
          {design.pattern === 'side-stripe' ? (
            <>
              <path d="M52 470L95 30H132L116 458Z" fill={design.secondary} />
              <path d="M348 470L305 30H268L284 458Z" fill={design.secondary} />
            </>
          ) : null}
          {design.pattern === 'split' ? (
            <path d="M200 30H305L348 470L230 462L200 280Z" fill={design.secondary} opacity=".33" />
          ) : null}
          <text
            x="200"
            y="220"
    ...
    <svg viewBox="0 0 920 650" role="img" aria-label="Custom team pants preview">
      ...
      {[110, 510].map((offset, index) => (
        <g key={offset} transform={`translate(${offset} 24)`} filter={`url(#${id}-shadow)`}>
          <path
            d="M90 30H310L350 590H225L200 280L175 590H50Z"
            fill={baseFill}
            stroke={design.secondary}
            strokeWidth="7"
          />
          ...
          {design.pattern === 'side-stripe' ? (
            <>
              <path d="M50 590L90 30H122L112 586Z" fill={design.secondary} />
              <path d="M350 590L310 30H278L288 586Z" fill={design.secondary} />
            </>
          ) : null}
          <text
            x="200"
  ...
  return (
    <svg viewBox="0 0 920 650" role="img" aria-label="Custom team apparel preview">
      ...
      <g transform="translate(235 30)" filter={`url(#${id}-shadow)`}>
        <path
          d="M168 24Q225 -10 282 24L324 62L400 112L364 184L324 164V512H126V164L86 184L50 112L126 62Z"
          fill={baseFill}
          stroke={design.secondary}
          strokeWidth="6"
        />
        <path
          d="M168 24Q225 90 282 24Q274 104 225 116Q176 104 168 24Z"
          fill={design.secondary}
          opacity=".26"
        />
        ...
        {tracksuit ? (
          <>
            <path
              d="M148 524H222L210 638H112Z"
              fill={baseFill}
              stroke={design.secondary}
              strokeWidth="5"
            />
            <path
              d="M228 524H302L338 638H240Z"
              fill={baseFill}
              stroke={design.secondary}
              strokeWidth="5"
            />
  ...
  return (
    <svg viewBox="0 0 760 560" role="img" aria-label="Custom sleeve preview">
      ...
      <g transform="translate(185 38)" filter={`url(#${id}-shadow)`}>
        ...
        <text
          transform="translate(195 354) rotate(-90)"
          textAnchor="middle"
          fill={design.secondary}
          fontFamily="Impact, sans-serif"
          fontSize="39"
  ...
  return (
    <svg viewBox="0 0 760 560" role="img" aria-label="Custom basketball preview">
      ...
      <g filter={`url(#${id}-shadow)`}>
        ...
        />
        <path
          d="M175 280H585M380 75V485M236 135Q380 280 524 425M524 135Q380 280 236 425"
          fill="none"
          stroke={design.secondary}
          strokeWidth="8"
          opacity=".85"
  ...
  return (
    <svg viewBox="0 0 920 580" role="img" aria-label="Custom basketball hoop padding preview">
      ...
      <g filter={`url(#${id}-shadow)`}>
        ...
        />
        <text
          transform="translate(460 330) rotate(-90)"
          textAnchor="middle"
          fill={design.secondary}
          fontFamily="Impact, sans-serif"
          fontSize="31"
    ...
    <div className={`design-preview ${className}`.trim()}>
      ...
      <p className="design-preview-disclaimer">
        {pick({
          ...
          ar: 'مسودة تصميم تفاعلية. لا يبدأ التصنيع إلا بعد اعتماد بروفة الإنتاج النهائية.',
        })}
      </p>
    </div>
  );
