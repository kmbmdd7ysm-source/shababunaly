-- Phase 1 owner-confirmed LHA stock truth.
-- Five physical pieces exist per listed color; sizes consume one shared color pool.
-- This migration makes the trusted transactional order path pool-aware and
-- prevents cross-size overselling under concurrent checkout.
