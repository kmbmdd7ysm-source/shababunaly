...
describe('production completion safeguards', () => {
  ...
  it('keeps final payment outstanding until verified', async () => {
    ...
    expect(sql).toContain("v_due=case when v_order='final_payment_required' then before_row.outstanding_balance");
  ...
  it('protects public forms with Turnstile and file scanning architecture', async () => {
    for (const path of ['src/pages/ContactPage.jsx','src/components/common/Newsletter.jsx','src/pages/TeamsWholesalePage.jsx','src/pages/CustomizePage.jsx','src/pages/SpecialRequestPage.jsx']) {
