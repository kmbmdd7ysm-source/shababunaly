...
| Item | Result |
| --- | --- |
| Final SHA | `8c18ca11a953978ed4467d8a369b1f8370630dae` |
...
| Live !important | **4** — foundation \`prefers-reduced-motion\` only |
...
| Media normalization | Manifest + 47 missing-final-media queue |
